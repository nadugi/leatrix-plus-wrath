----------------------------------------------------------------------
-- 	Leatrix Plus 2.5.81.alpha.10 (29th December 2021)
----------------------------------------------------------------------
...
----------------------------------------------------------------------
	...
	-- Version
	LeaPlusLC["AddonVer"] = "2.5.81.alpha.10"
...
----------------------------------------------------------------------
	...
	LeaPlusLC:MakeCB(LeaPlusLC[pg], "ShowFlightTimes"			, 	"Show flight times"				, 	340, -272, 	true,	"If checked, a flight time progress bar will be shown when you take a flight.|n|nFor the time being, the flight time will be printed in chat when you land so that you can report inaccurate or missing flight times.|n|nNote that for non-English locales, the progress bar and flight time will only show if the start and destination flight point names have been translated.")
