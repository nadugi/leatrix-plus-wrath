----------------------------------------------------------------------
-- 	Leatrix Plus 2.5.77 (17th December 2021)
----------------------------------------------------------------------
				...
				local function MakeButtons()
					...
					for i = 1, #temp do
						if temp[i] then
							...
							if name and btype == "Button" and not CustomAddonTable[name] and btn:GetScript("OnClick") and not string.find(name, "Questie") and not string.find(name, "LibDBIcon") and not issecurevariable(name) and btn:IsShown() then
